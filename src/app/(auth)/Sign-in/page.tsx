...
export default function page() {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-800">
            <div className="w-full max-w-md p-8 bg-white rounded-lg inset-shadow-2xs">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        />
                        <Button className='w-full bg-blue-600 text-white hover:bg-blue-300 hover:text-black' type="submit">Sign In</Button>
                    </form>
                </Form>
